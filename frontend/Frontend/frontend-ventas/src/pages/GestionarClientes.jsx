...
import { getClientes, createProducto, updateProducto, getMarcas, getCategorias, getProveedores, getUsuarios, getRoles, getCompras, createProducto as createCliente } from '../api';
import api from '../api';
...
function GestionarClientes() {
  ...
  const handleGuardar = async () => {
    try {
      await api.put(`/clientes/${clienteEdit.id_cliente}`, {
